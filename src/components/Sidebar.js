...
import { faChartPie, faCog, faSignOutAlt, faTable, faTimes, faRocket, faCashRegister } from "@fortawesome/free-solid-svg-icons";
        ...
        <SimpleBar className={`collapse ${showClass} sidebar d-md-block bg-primary text-white`}>
          <div className="sidebar-inner px-4 pt-3 mt-4">
            ...
            <Nav className="flex-column pt-3 pt-md-0">
              <NavItem title="Leras Coffee" image={ReactHero} link={""} />
              ...
              <NavItem title="Menü" icon={faChartPie} link={Routes.Menu.path} />
