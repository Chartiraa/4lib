...
export const ProductButton = ({ productName, productImage, productPrice }) => {
  return (
    <>
      ...
      <div>
        <p className="text-black" style={{ fontFamily: 'Montserrat, sans-serif', fontWeight: '600', marginBottom: "-0.3rem" }}>{productName}</p>
        <p className="text-black" style={{ fontFamily: 'Montserrat, sans-serif', fontWeight: '400' }}>{productPrice} ₺</p>
      </div>
